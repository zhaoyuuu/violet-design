...
export type InputProps = Merge<Omit<IPickerInputProps, 'onBlur' | 'onClear' | 'onChange' | 'onClick' | 'placeholder'>, {
    /** 起始输入框placeholder */
...
declare class RangePickerInput extends React.Component<Props> {
    ...
    renderPickerInput: (fieldType: FieldType, value?: string, placeholder?: string) => JSX.Element;
    render(): JSX.Element;
}
