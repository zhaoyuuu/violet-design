...
type CalendarProps = Merge<Omit<ICalendarProps, 'base' | 'onChange' | 'selected'>, {
    showMonthCnt?: number;
}>;
...
export declare class RangeDatePicker extends React.Component<Props, State> {
    ...
    handleDateChange: (actions: PickerAction) => (year?: dayjs.Dayjs, month?: dayjs.Dayjs, date?: dayjs.Dayjs) => void;
