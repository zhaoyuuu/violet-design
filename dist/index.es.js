...
var Button = function (props) {
    ...
    var debouncedClick = debounceClick();
    ...
    if (btnType === 'link' && href) {
        ...
        return (jsx("button", __assign({ className: cls, disabled: disabled }, restProps, { onClick: function (e) {
                if (debouncedClick) {
                    debouncedClick(e);
                }
            } }, { children: children })));
...
var Option = function (props) {
    ...
    jsxs("li", __assign({ className: className, onClick: function (e) { return handleClick(e, value, isSelected); } }, { children: [children || (label ? label : value), multiple && isSelected && jsx(Icon, { icon: "check" })] }), index));
};
