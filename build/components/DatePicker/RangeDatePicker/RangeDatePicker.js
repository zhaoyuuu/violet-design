...
import { isDayAfter, isDayBefore, isDayEqual, isDayRange, formatDate, DatePickerDefaults, ifExistCall, } from '../../../_utils/DateUtil';
import Picker from '../Picker';
import RangePickerInput, { FieldType } from './RangePickerInput';
...
var RangeDatePicker = /** @class */ (function (_super) {
    ...
    function RangeDatePicker(props) {
        ...
        _this.handleDateChange = function (actions) {
            return function (year, month, date) {
                ...
                _this.setState(__assign(__assign({}, _this.state), { start: startDate, end: endDate, startValue: formatDate(startDate, dateFormat), endValue: formatDate(endDate, dateFormat) }), function () {
        ...
        _this.handleInputChange = function (fieldType, value) {
            var _a;
            var key = fieldType === FieldType.START ? 'startValue' : 'endValue';
        ...
        _this.handleInputBlur = function (fieldType, value) {
            ...
            _this.setState(__assign(__assign({}, _this.state), { start: startDate, end: endDate, startValue: formatDate(startDate, dateFormat), endValue: formatDate(endDate, dateFormat) }));
        };
        _this.handleCalendarText = function (date) {
            ...
            var _b = _this.state, start = _b.start, end = _b.end;
            if (isDayEqual(start, date))
                return startText;
            if (isDayEqual(end, date))
                return endText;
        ...
        _this.renderRangePickerInput = function () {
            ...
            return (React.createElement(RangePickerInput, { startPlaceholder: startPlaceholder, readOnly: readOnly, disabled: disabled, clear: clear, endPlaceholder: endPlaceholder, startValue: startValue, endValue: endValue, onChange: _this.handleInputChange, onBlur: _this.handleInputBlur, onClear: _this.handleInputClear }));
        };
        _this.renderCalendar = function (actions) {
            ...
            var _b = _this.state, start = _b.start, end = _b.end;
            var component;
            var calendar = (React.createElement(Calendar, __assign({}, _this.props, { base: start || initialDate, startDay: start, endDay: end, showMonthCnt: showMonthCnt, onChange: _this.handleDateChange(actions), onMouseOver: _this.handleMouseOver, customDayText: _this.handleCalendarText, customDayClass: _this.handleCalendarClass })));
            component = calendar;
            if (wrapper) {
    ...
    RangeDatePicker.prototype.render = function () {
        ...
        return (React.createElement(Picker, { portal: portal, direction: direction, readOnly: readOnly, disabled: disabled, renderTrigger: function () { return _this.renderRangePickerInput(); }, renderContents: function (_a) {
