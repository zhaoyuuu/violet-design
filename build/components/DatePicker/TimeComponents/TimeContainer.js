...
var TimeContainer = /** @class */ (function (_super) {
    ...
    TimeContainer.prototype.render = function () {
        ...
        return (React.createElement("div", { className: "time__container" },
            React.createElement(TimeInput, { onUp: this.handleUp('hour'), onDown: this.handleDown('hour'), onChange: this.handleChange('hour'), onBlur: this.handleBlur, value: hour }),
            React.createElement("div", { className: "time__container__div" }, ":"),
            React.createElement(TimeInput, { onUp: this.handleUp('minute'), onDown: this.handleDown('minute'), onChange: this.handleChange('minute'), onBlur: this.handleBlur, value: minute })));
    };
